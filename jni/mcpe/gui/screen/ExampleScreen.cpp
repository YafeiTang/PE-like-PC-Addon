...
void ExampleScreen::init() {
	...
	_exampleButton = new Touch::TButton(0, "Back", NULL, false);

	// 헤더를 생성합니다. 첫번째 인자는 모르겠어요.. 나타나는 헤더는 "Header" 입니다.
	_exampleHeader = new Touch::THeader(0, "PE like PC info");
...
void ExampleScreen::setupPositions() {
	...
	// y좌표는 헤더 높이 + 10
	_exampleButton->_y = /*_exampleHeader->_height + 10*/4;
	
	_exampleButton->_width = 40;
	
	_exampleButton->_height = 18;
}
